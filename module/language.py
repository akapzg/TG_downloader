...
translations = {
    ...
    "Timing out after 3 retries, download skipped": [
        "超时重试超过3次,跳过下载",
    ...
    "Sync local files to Cloud Drive": [
        "同步本地文件到云盘",
        "Синхронизировать локальные файлы с облаком",
        "Синхронізувати локальні файли з хмарним сховищем",
    ],
    "Starting manual cloud sync...": [
        "正在开始手动同步云盘...",
        "Начало ручной синхронизации с облаком...",
        "Початок ручної синхронізації з хмарним сховищем...",
    ],
    "Manual cloud sync completed successfully.": [
        "手动同步云盘成功完成。",
        "Ручная синхронизация с облаком успешно завершена.",
        "Ручна синхронізація з хмарним сховищем успішно завершена.",
    ],
    "Manual cloud sync failed or is disabled.": [
        "手动同步云盘失败，或该功能已禁用。",
        "Ручная синхронизация с облаком не удалась или отключена.",
        "Ручна синхронізація з хмарним сховищем не вдалася або відключена.",
    ],
}
